...
public class PatternJsonEncoder extends EncoderBase<ILoggingEvent> {
    ...
    public byte[] encode(ILoggingEvent event) {
        ...
        appenderMember(sb, MESSAGE_ATTR_NAME, jsonEscape(MessageFormatter.basicArrayFormat(
                event.getMessage(), event.getArgumentArray()
        )));
